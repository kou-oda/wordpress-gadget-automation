...
PA-APIから12秒間隔でリクエストを送信し、安全に100個の商品を自動取得します。

**特徴:**
- ✅ 完全自動化
- ✅ レート制限を考慮（PA-API 5.0: 10秒に1リクエスト + 安全マージン2秒）
- ✅ GitHub Actionsで実行
- ⏱️ 所要時間: 約20-25分
...
**注意:**
- PA-API 5.0のレート制限（10秒に1リクエスト）に2秒の安全マージンを加えた12秒間隔でリクエストを送信
- 100個の商品取得に約20-25分かかります
- GitHub Actionsは35分でタイムアウトするため、十分余裕があります
